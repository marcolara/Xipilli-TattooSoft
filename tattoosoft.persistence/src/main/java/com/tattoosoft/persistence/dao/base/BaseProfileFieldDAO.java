 ...
 * level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.ProfileField
 *
...
public class BaseProfileFieldDAO extends AbstractBaseDAO<ProfileField> {
	...
	private static final Logger log = LoggerFactory.getLogger(BaseProfileFieldDAO.class);
	public static final String SPRING_BEAN_ID = BaseProfileFieldDAO.class.getSimpleName();
