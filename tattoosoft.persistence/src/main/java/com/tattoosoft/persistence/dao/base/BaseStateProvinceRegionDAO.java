 ...
 *
 * @see com.tattoosoft.persistence.reveng.tmp.StateProvinceRegion
 *
 *      Generated using template: -
 *      tattoosoft-persistence\reveng\tattoosoft-myeclipse_templates_8.5\dao\daohome.vm
 */
public class BaseStateProvinceRegionDAO extends AbstractBaseDAO<StateProvinceRegion> {
	// <revengLogSuppress/>
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(BaseStateProvinceRegionDAO.class);
	public static final String SPRING_BEAN_ID = BaseStateProvinceRegionDAO.class.getSimpleName();
