 ...
 * base level.
 *
 * @see tattoosoft.persistence.reveng.tmp.ShopEmployeeGroup
 *
...
public class BaseShopEmployeeGroupDAO extends AbstractBaseDAO<ShopEmployeeGroup> {
	...
	private static final Logger log = LoggerFactory
			.getLogger(BaseShopEmployeeGroupDAO.class);
	public static final String SPRING_BEAN_ID = BaseShopEmployeeGroupDAO.class
			.getSimpleName();
