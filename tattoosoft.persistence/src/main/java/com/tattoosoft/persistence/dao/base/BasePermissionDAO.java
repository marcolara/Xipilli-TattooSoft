 ...
 * level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.Permission
 *
...
public class BasePermissionDAO extends AbstractBaseDAO<Permission> {
	...
	private static final Logger log = LoggerFactory.getLogger(BasePermissionDAO.class);
	public static final String SPRING_BEAN_ID = BasePermissionDAO.class.getSimpleName();
