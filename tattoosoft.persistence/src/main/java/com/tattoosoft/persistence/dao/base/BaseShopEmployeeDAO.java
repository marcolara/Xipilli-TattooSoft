 ...
 * level.
 *
 * @see tattoosoft.persistence.reveng.tmp.ShopEmployee
 *
...
public class BaseShopEmployeeDAO extends AbstractBaseDAO<ShopEmployee> {
	...
	private static final Logger log = LoggerFactory
			.getLogger(BaseShopEmployeeDAO.class);
	public static final String SPRING_BEAN_ID = BaseShopEmployeeDAO.class
			.getSimpleName();
