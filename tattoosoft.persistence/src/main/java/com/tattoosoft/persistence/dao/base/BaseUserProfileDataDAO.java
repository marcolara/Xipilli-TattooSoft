 ...
 * base level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.UserProfileData
 *
...
public class BaseUserProfileDataDAO extends AbstractBaseDAO<UserProfileData> {
	...
	private static final Logger log = LoggerFactory.getLogger(BaseUserProfileDataDAO.class);
	public static final String SPRING_BEAN_ID = BaseUserProfileDataDAO.class.getSimpleName();
	...
	public List<UserProfileData> findByBlobValue(Object blobValue) {
		return findByProperty(BLOB_VALUE, blobValue);
	}

	public UserProfileData findUniqueByBlobValue(Object blobValue) {
		return findUniqueByProperty(BLOB_VALUE, blobValue);
	}
