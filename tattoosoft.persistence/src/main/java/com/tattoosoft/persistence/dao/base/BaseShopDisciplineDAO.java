 ...
 * base level.
 *
 * @see tattoosoft.persistence.reveng.tmp.ShopDiscipline
 *
...
public class BaseShopDisciplineDAO extends AbstractBaseDAO<ShopDiscipline> {
	...
	private static final Logger log = LoggerFactory
			.getLogger(BaseShopDisciplineDAO.class);
	public static final String SPRING_BEAN_ID = BaseShopDisciplineDAO.class
			.getSimpleName();
