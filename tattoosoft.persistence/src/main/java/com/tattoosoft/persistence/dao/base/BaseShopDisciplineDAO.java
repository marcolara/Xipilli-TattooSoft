...
import com.tattoosoft.persistence.model.ShopDiscipline;
...
/**
 * DAO providing persistence and search support for ShopDiscipline entities.
 ...
 * base level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.ShopDiscipline
 *
 *      Generated using template: -
 *      tattoosoft-persistence\reveng\tattoosoft-myeclipse_templates_8.5\dao\daohome.vm
 */
public class BaseShopDisciplineDAO extends AbstractBaseDAO<ShopDiscipline> {
	// <revengLogSuppress/>
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(BaseShopDisciplineDAO.class);
	public static final String SPRING_BEAN_ID = BaseShopDisciplineDAO.class.getSimpleName();
	// id property constant
	public static final String ID = "id";
	// property constants
	public static final String STATUS = "status";

	public BaseShopDisciplineDAO() {
		super(ShopDiscipline.class, ID);
	}

	/******
	 * Property finder convenience methods:
	 **************************************************/
	public List<ShopDiscipline> findByStatus(Object status) {
		return findByProperty(STATUS, status);
	}

	public ShopDiscipline findUniqueByStatus(Object status) {
