 ...
 * level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.DaysOfWeek
 *
...
public class BaseDaysOfWeekDAO extends AbstractBaseDAO<DaysOfWeek> {
	...
	private static final Logger log = LoggerFactory.getLogger(BaseDaysOfWeekDAO.class);
	public static final String SPRING_BEAN_ID = BaseDaysOfWeekDAO.class.getSimpleName();
