...
import com.tattoosoft.persistence.dao.base.BaseShopDisciplineDAO;

/**
 * @author malara
 *
 */
@Component("ShopDisciplineDAO")
public class ShopDisciplineDAO extends BaseShopDisciplineDAO {
