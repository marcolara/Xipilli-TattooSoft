 ...
 * base level.
 *
 * @see tattoosoft.persistence.reveng.tmp.RolePermission
 *
...
public class BaseRolePermissionDAO extends AbstractBaseDAO<RolePermission> {
	...
	private static final Logger log = LoggerFactory
			.getLogger(BaseRolePermissionDAO.class);
	public static final String SPRING_BEAN_ID = BaseRolePermissionDAO.class
			.getSimpleName();
