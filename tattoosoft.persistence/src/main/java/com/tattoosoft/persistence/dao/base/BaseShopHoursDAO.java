...
import com.tattoosoft.persistence.model.ShopHours;
...
/**
 * DAO providing persistence and search support for ShopHours entities. Save,
 ...
 * level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.ShopHours
 *
 *      Generated using template: -
 *      tattoosoft-persistence\reveng\tattoosoft-myeclipse_templates_8.5\dao\daohome.vm
 */
public class BaseShopHoursDAO extends AbstractBaseDAO<ShopHours> {
	// <revengLogSuppress/>
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(BaseShopHoursDAO.class);
	public static final String SPRING_BEAN_ID = BaseShopHoursDAO.class.getSimpleName();
	// id property constant
	public static final String ID = "id";
	// property constants
	public static final String STATUS = "status";

	public BaseShopHoursDAO() {
		super(ShopHours.class, ID);
	}

	/******
	 * Property finder convenience methods:
	 **************************************************/
	public List<ShopHours> findByStatus(Object status) {
		return findByProperty(STATUS, status);
	}

	public ShopHours findUniqueByStatus(Object status) {
