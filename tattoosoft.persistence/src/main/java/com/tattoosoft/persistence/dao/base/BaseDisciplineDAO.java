 ...
 * level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.Discipline
 *
...
public class BaseDisciplineDAO extends AbstractBaseDAO<Discipline> {
	...
	private static final Logger log = LoggerFactory.getLogger(BaseDisciplineDAO.class);
	public static final String SPRING_BEAN_ID = BaseDisciplineDAO.class.getSimpleName();
