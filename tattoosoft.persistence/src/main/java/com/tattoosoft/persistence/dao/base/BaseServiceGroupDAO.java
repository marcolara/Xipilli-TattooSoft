 ...
 * level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.ServiceGroup
 *
...
public class BaseServiceGroupDAO extends AbstractBaseDAO<ServiceGroup> {
	...
	private static final Logger log = LoggerFactory.getLogger(BaseServiceGroupDAO.class);
	public static final String SPRING_BEAN_ID = BaseServiceGroupDAO.class.getSimpleName();
