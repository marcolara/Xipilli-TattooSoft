 ...
 * level.
 *
 * @see com.tattoosoft.persistence.reveng.tmp.UserRole
 *
...
public class BaseUserRoleDAO extends AbstractBaseDAO<UserRole> {
	...
	private static final Logger log = LoggerFactory.getLogger(BaseUserRoleDAO.class);
	public static final String SPRING_BEAN_ID = BaseUserRoleDAO.class.getSimpleName();
